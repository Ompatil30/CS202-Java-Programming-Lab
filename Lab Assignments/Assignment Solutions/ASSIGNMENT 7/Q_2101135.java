...
//class User is declared abstract 
abstract class User{
    ...
    //We have declared our extractYear method to be final so that it cannot be overridden by its subclasses as we don't need its modified form
    //in any of the subclasses
    final int extractYear(int inpYear) {
        int start, end;
...
//We declare our Student, Staff and Faculty classes to be final so that no other classes may inherit these classes 
...
public class Q_2101135 {
    ...
    public static void main(String[] args) {
        ...
        //User u1=new User(); --> shows an error as object of an abstarct class cant be made
        //Please uncomment the above line to see the error
            ...
            if (userType == 1) {
                while (true) {
                    ...
                    if (choice == 1) {
                        ...
                        int detailInput;
                        System.out.println(
                                "You want to see details on the basis of: 1.User ID OR 2.Birth year. Enter the number 1 or 2:");
                ...
                while (true) {
                    ...
                    if (choice == 1) {
                        ...
                        int detailInput;
                        System.out.println(
                                "You want to see details on the basis of: 1.User ID OR 2.Birth year OR 3.Employee ID. Enter the number 1,2 or 3:");
                        detailInput = sc.nextInt();
